...
public interface UserRepository extends JpaRepository<User, Long> {
   ...
   */
  @Modifying
  @Procedure(name = "sp_update_user_by_role_admin")
   ...
   */
  @Modifying
  @Procedure(name = "sp_update_user_by_role_user")
   ...
   */
  @Modifying
  @Procedure(name = "sp_update_user_role_with_status_check")
   ...
   */
  @Modifying
  @Procedure(name = "sp_change_nickname")
   ...
   */
  @Modifying
  @Procedure(name = "sp_change_email")
  void spChangeEmail(
      @Param("id_user") long id,
   ...
   */
  @Modifying
  @Procedure(name = "sp_change_password")
